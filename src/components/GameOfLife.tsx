...
export default function GameOfLife() {
  ...
  const initGliderGun = useCallback(
    (c: number, r: number) => {
  ...
  useEffect(() => {
    ...
    function draw(ts: number) {
      if (
        ...
        inViewRef.current &&
        running &&
        ts - lastTickRef.current > TICK_MS
      ) {
  ...
  return (
    <div className="widget-card" ref={wrapRef}>
      <div className="widget-header">
        <span className="widget-kicker">Life</span>
        <div className="widget-controls">
          <button type="button" onClick={() => setRunning((r) => !r)} className="widget-btn">
            {running ? 'Pause' : 'Play'}
          </button>
          <button type="button" onClick={reset} className="widget-btn">
            Random
          </button>
          <button type="button" onClick={clear} className="widget-btn">
            Clear
          </button>
        </div>
      </div>
